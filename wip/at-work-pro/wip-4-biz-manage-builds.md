...
In either case, you will be using the __Manage preview builds__ and __Branch Readiness Level__ settings. The __Manage preview builds__ setting allows you to enable or disable installation of the preview builds. The __Branch Readiness Level__ setting allows you to set which branch a device receives their updates from.
