...
You can get builds of 20H1 today if you've opted in to the **Fast** ring.

The items in **bold** are the latest releases for the individual versions of the item. 

| Build | Fast | Slow | Server | IoT | ISO | SDK |
|-------|------|------|--------|-----|-----|-----|
|18945|[**7/26/2019**](https://blogs.windows.com/windowsexperience/2019/07/26/announcing-windows-10-insider-preview-build-18945/)||||||
