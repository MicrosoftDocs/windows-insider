...
When you look through the list of categories and subcategories, some likely seem straight-forward, like the Microsoft Store category for feedback on the store experience. But this guidecan help you choose between some of the others.

### Apps

Use the apps category for issues opening or any issues ou experience inside apps on your device. The subcategory should be the app's name, or if we don't have a subcategory for that app, which is common for many third-party apps, choose All other apps from the bottom of the list.

### Gaming and Xbox

Issues you experience while gaming or using Xbox features on Windows should be sent here, including Game Bar, using controllers, game crashes and performance, issues using your Xbox account, or recording. If your issue doesn't fit neatly into its subcategories, use All other issues at the top of the list.
...
This is where feedback on the Windows Insider Program's content or forums should be sent. 
...
Use this only for the taskbar date and time and calendar that opens when you select it. Feedback for the calendar app should go to **Apps** > **Calendar** instead, and issues with your settings should go to **Settings** > **Date and Time Settings** instead.
...
Use this for issues with using app windows on your desktop, like issues with them going behind things, their freame, or the close, maximize, and minimize buttons on your app window.
...
If something is wrong with your device and its hardware, like audio or sound, or connecting to other devices, like Bluetooth, USB keyboards, printers, or scanners, use this category.

### Display and graphics

If something is wrong with your display, like using multiple displays, brightness, night light, scaling, or resolutions, use this category.

### Files, folders, and online storage

Use this for any issues with File Explorer, OneDrive, your storage settings, or disk space, use this category.

### Input and language

Use this category for all things input, including things like your mouse or pen not working, the emoji panel, keyboard and language switching, or your keyboard not working to type or hardware keys not working, which should go to the Text input subcategory.

### Install and update

Use this category for all issues with updates, like issues installing an update, backup and restore, or loss of settings after an update.

### Network and internet

Use this category for all issues around your internet and network connectivity, like VPNs, connecting to wi-fi, ethernet, or cellular, and the network troubleshooter.

### Power and battery

Use this category for all issues with your power, like powering on or off or sleep, or with your battery, like battery saver, overheating, or app energy consumption.

### Recovery and uninstall

Use this category for issues with things like reset this PC, image backups, and USB recovery drives.

### Security and privacy

Use this category for all things security, like BitLocker, encryption, Microsoft Defender, logging into your device or Windows Hello, or issues with your account.

### Settings

Use this category for any issues with your settings, like personalization, date and time, sound, and Windows update.

## Include the diagnostics needed to investigate

In certain categories and subcategories, we need certain diagnostics attached with your report to be able to take action.
...
For issues with your keyboard, first make sure your OEM drivers are up to date. Once you've confirmed that, be sure to file them to the **Input and language** > **Text input** category and subcategory. Then:
...
1. Use **Recreate your problem or suggestion** and make sure the box for **Include data about** is checked. Then open the dropdown beside General and choose **Performance** instead.
2. Select **Start recording**.
